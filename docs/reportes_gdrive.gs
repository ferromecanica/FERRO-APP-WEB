/**
 * Generador de reportes PDF de Ferro (mismo motor que el reporte de AppSheet).
 *
 * Ferro manda el HTML del reporte; este script reemplaza __LOGO__, __FIRMA__ y
 * __FOTO:archivo__ por las imágenes de Drive, lo convierte a PDF, lo guarda en la
 * carpeta de reportes (reemplazando uno anterior con el mismo nombre) y devuelve el link.
 *
